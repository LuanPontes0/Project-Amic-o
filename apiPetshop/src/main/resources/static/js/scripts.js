...
function criaModal(id, nome, idade, raca, comportamento, imagem) {
    ...
    $(".adotar-menu .row").append(`<div class="modal fade" id="myModal" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" data-dismiss="modal" onClick="criaFormulario(),document.getElementById('myModal').remove()">Adotar</button>
