...
public class UsuarioController {
    ...
    @PostMapping("/login")
    public ModelAndView login(@Valid UsuarioModel usuario, BindingResult br, HttpSession session, HttpServletResponse response) throws NoSuchAlgorithmException, ServiceExc{
        ...
        if(userLogin == null){
            ...
            CookieSErvice.setCookie(response, "usuarioId", String.valueOf(userLogin.getId()),60 );
            return index();
        }
        return mv;
    }
